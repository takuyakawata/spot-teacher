...
open class AdminUsers(
     ...
     */
    val ADMIN_ROLE: TableField<AdminUsersRecord, AdminUsersAdminRole?> = createField(
        DSL.name("admin_role"),
        SQLDataType.VARCHAR(6).nullable(false).defaultValue(DSL.inline("NORMAL", SQLDataType.VARCHAR)).asEnumDataType(AdminUsersAdminRole::class.java),
        this,
        ""
    )
     ...
     */
    val CREATED_AT: TableField<AdminUsersRecord, LocalDateTime?> = createField(
        DSL.name("created_at"),
     ...
     */
    val UPDATED_AT: TableField<AdminUsersRecord, LocalDateTime?> = createField(
        DSL.name("updated_at"),
        SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)),
        this,
        ""
