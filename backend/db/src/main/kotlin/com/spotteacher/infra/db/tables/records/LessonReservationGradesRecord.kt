 ...
 */
@Suppress("warnings")
open class LessonReservationGradesRecord private constructor() : UpdatableRecordImpl<LessonReservationGradesRecord>(LessonReservationGrades.LESSON_RESERVATION_GRADES) {
    ...
    /**
     * Create a detached, initialised LessonReservationGradesRecord
     */
    constructor(lessonReservationId: Long, gradeCode: String, displayOrder: Int? = null): this() {
