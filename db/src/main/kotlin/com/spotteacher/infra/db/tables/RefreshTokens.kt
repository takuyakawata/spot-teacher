...
open class RefreshTokens(
     ...
     */
    val CREATED_AT: TableField<RefreshTokensRecord, LocalDateTime?> = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "")
    ...
    override fun getPrimaryKey(): UniqueKey<RefreshTokensRecord> = Internal.createUniqueKey(RefreshTokens.REFRESH_TOKENS, DSL.name("KEY_refresh_tokens_PRIMARY"), arrayOf(RefreshTokens.REFRESH_TOKENS.ID), true)
