...
open class AdminUsers(
     ...
     */
    val ADMIN_ROLE: TableField<AdminUsersRecord, AdminUsersAdminRole?> =
        createField(DSL.name("admin_role"), SQLDataType.VARCHAR(6).nullable(false).defaultValue(DSL.inline("NORMAL", SQLDataType.VARCHAR)).asEnumDataType(AdminUsersAdminRole::class.java), this, "")

    /**
     * The column <code>admin_users.created_at</code>.
     */
    val CREATED_AT: TableField<AdminUsersRecord, LocalDateTime?> =
     ...
     */
    val UPDATED_AT: TableField<AdminUsersRecord, LocalDateTime?> =
